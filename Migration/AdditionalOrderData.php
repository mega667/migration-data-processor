 ...
 */
class AdditionalOrderData implements StageInterface
{
    /**
    ...
    public function __construct(
        ...
        Logger $logger,
        Config $config,
        \Migration\Step\Map\Helper $helper,
    ...
    protected function documentIsAllowed($document)
    {
        $allowedDocs = [
        ...
        return in_array($document, $allowedDocs);
    }
    ...
    public function perform()
    {
        ...
        foreach (array_diff($sourceDocuments, $processedDocuments) as $sourceDocName) {
            ...
            if (!$this->documentIsAllowed($sourceDocName)) {
                continue;
            }
            if (!$destinationName) {
                continue;
